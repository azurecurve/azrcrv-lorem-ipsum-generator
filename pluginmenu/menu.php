 ...
 * @since 1.0.0
 */
if ( ! function_exists( 'azrcrv_create_plugin_menu_l' ) ) {
	function azrcrv_create_plugin_menu_lig() {
		azrcrv_populate_plugin_menu_lig();
	}
}
 ...
 * @since 1.0.0
 */
if ( ! function_exists( 'azrcrv_populate_plugin_menu_lig' ) ) {
	function azrcrv_populate_plugin_menu_lig() {
